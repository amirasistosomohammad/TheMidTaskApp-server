...
<head>
  ...
  <title>Task approved: {{ $taskName }} – {{ config('app.name') }}</title>
</head>
        ...
        <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="max-width: 600px; margin: 0 auto; background-color:#ffffff; border: 1px solid #cbd5e0;">
          ...
          <tr>
            <td style="padding: 28px;">
              ...
              <p style="margin: 0 0 20px 0; font-size: 15px; color: #2d3748;">Your submitted task has been reviewed and <strong>approved</strong> by your School Head.</p>
              ...
              <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="margin: 20px 0;">
                <tr>
                  <td style="background-color: #f0fff4; border-left: 4px solid #38a169; padding: 16px 20px;">
              ...
              <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="margin-top: 24px;">
                <tr>
                  <td style="padding: 8px 0 20px 0;">
                    <a href="{{ $url }}" target="_blank" rel="noopener noreferrer" style="display: inline-block; background-color: #0B558F; color: #ffffff; font-size: 14px; font-weight: 600; text-decoration: none; padding: 12px 24px;">View task</a>
                  </td>
                </tr>
              </table>
              @endif
