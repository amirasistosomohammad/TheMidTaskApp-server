...
<head>
  ...
  <title>New task assigned: {{ $taskName }} – {{ config('app.name') }}</title>
</head>
        ...
        <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="max-width: 600px; margin: 0 auto; background-color:#ffffff; border: 1px solid #cbd5e0;">
          ...
          <tr>
            <td style="padding: 28px;">
              ...
              <p style="margin: 0 0 20px 0; font-size: 15px; color: #2d3748;">A new task has been assigned to you by the Central Administrative Officer.</p>
