...
<head>
  ...
  <title>Reminder: {{ $taskName }} due on {{ $dueDate }} – {{ config('app.name') }}</title>
</head>
        ...
        <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="max-width: 600px; margin: 0 auto; background-color:#ffffff; border: 1px solid #cbd5e0;">
          ...
          <tr>
            <td style="padding: 28px;">
              ...
              <p style="margin: 0 0 8px 0; font-size: 15px; color: #2d3748;">This is an automatic reminder for your assigned task <strong>"{{ $taskName }}"</strong>.</p>
              <p style="margin: 0 0 20px 0; font-size: 15px; color: #e53e3e; font-weight: 600;">{{ $lineWhen }}</p>
