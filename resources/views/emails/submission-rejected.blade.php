...
<head>
  ...
  <title>Task returned for revision: {{ $taskName }} – {{ config('app.name') }}</title>
</head>
        ...
        <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="max-width: 600px; margin: 0 auto; background-color:#ffffff; border: 1px solid #cbd5e0;">
          ...
          <tr>
            <td style="padding: 28px;">
              ...
              <p style="margin: 0 0 20px 0; font-size: 15px; color: #2d3748;">Your submitted task has been reviewed by your School Head and was <strong>returned for revision</strong>.</p>
              ...
              <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="margin: 20px 0;">
                <tr>
                  <td style="background-color: #fff5f5; border-left: 4px solid #e53e3e; padding: 16px 20px;">
                    <p style="margin: 0 0 4px 0; font-size: 12px; color: #718096; font-weight: 600;">Feedback</p>
                    <p style="margin: 0; font-size: 15px; color: #2d3748;">{{ $feedback }}</p>
                  </td>
                </tr>
              </table>
              @endif
              
              <p style="margin: 20px 0 0 0; font-size: 15px; color: #4a5568;">Please make the necessary changes and resubmit the task.</p>
              
              @if(!empty($url))
              <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="margin-top: 24px;">
                <tr>
                  <td style="padding: 8px 0 20px 0;">
                    <a href="{{ $url }}" target="_blank" rel="noopener noreferrer" style="display: inline-block; background-color: #0B558F; color: #ffffff; font-size: 14px; font-weight: 600; text-decoration: none; padding: 12px 24px;">View task and resubmit</a>
                  </td>
                </tr>
              </table>
              @endif
